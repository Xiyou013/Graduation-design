...
export default {
  ...
  mounted() {
    ...
    this.params.id = this.$route.params.id || localStorage.userid;
    this.params.tel = this.$route.params.tel;
    this.params.account = this.$route.params.account || localStorage.accountdetails;
