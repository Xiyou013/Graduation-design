      ...
      <div class="eadd_con">
        ...
        <div class="eadd_con_basic">
          ...
          <div class="eadd_cb_wk">
            ...
            <div class="r_elabel">
              <!-- <div
                class="eadd_cb_elabel"
                v-for="(item, index) in elabel"
                :key="index"
              >
                {{ item.ename }}
              </div> -->
...
export default {
  ...
  methods: {
    ...
    plabeldel(val) {
      console.log("val:", val);
      this.handlechange(val, "plabelRegionDel", 3);
    },
    ...
    addLrpeopleFn(val) {
      ...
      this.companyInformation.lrpeople = this.curDimesion[0] ? this.curDimesion[0].kjwl_p_name : null;
      this.companyInformation.lrpeopleId = this.curDimesion[0] ? this.curDimesion[0].kjwl_p_id : null;
    },
    async handlerSave() {
      ...
      if (this.companyInformation.companyName === "") {
        ...
        let res = await this.$axios.post("/api/admin/enterpriseadd", {
